...
/* package diamond-kata-0.1.0.0 */
#define VERSION_diamond_kata "0.1.0.0"
#define MIN_VERSION_diamond_kata(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "diamond-kata-0.1.0.0-GKCazZTlVLHDrJIIWIIZgg"

#define CURRENT_PACKAGE_KEY "diamond-kata-0.1.0.0-GKCazZTlVLHDrJIIWIIZgg"
